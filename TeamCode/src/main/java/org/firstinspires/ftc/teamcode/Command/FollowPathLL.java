...
public class FollowPathLL extends CommandBase {
    ...
    public FollowPathLL(PathFollower follower, LimeLightSubSystem limeLight, Pose startPose, Pose endPose, double power) {
        m_follower = follower;
