...
class ForwardVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.addLine("pose" + follower.getPose());
        telemetryM.update(telemetry);
...
class LateralVelocityTuner extends OpMode {
    ...
    @Override
    public void init_loop() {
        telemetryM.addLine("The robot will run at 1 power until it reaches " + DISTANCE + " inches to the right.");
        telemetryM.addLine("Make sure you have enough room, since the robot has inertia after cutting power.");
...
class LateralZeroPowerAccelerationTuner extends OpMode {
    ...
    @Override
    public void init_loop() {
        telemetryM.addLine("The robot will run to the right until it reaches " + VELOCITY + " inches per second.");
        telemetryM.addLine("Then, it will cut power from the drivetrain and roll to a stop.");
        telemetryM.addLine("Make sure you have enough room.");
